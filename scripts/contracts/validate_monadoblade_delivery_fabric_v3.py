...
def validate_storage_contract(storage_contract: dict) -> list[str]:
    ...
    _append(errors, isinstance(forbidden, list) and "disk_or_vhdx-apply-from-runtime" in forbidden, "storage forbiddenRuntimeActions must include disk_or_vhdx-apply-from-runtime")
    return errors
