...
def validate_storage_contract(storage_contract: dict) -> list[str]:
    ...
    _append(errors, isinstance(forbidden, list) and "physical_disk_apply_from_runtime" in forbidden, "storage forbiddenRuntimeActions must include physical_disk_apply_from_runtime")
    _append(errors, isinstance(forbidden, list) and "vhdx-apply-from-runtime" in forbidden, "storage forbiddenRuntimeActions must include vhdx-apply-from-runtime")
    return errors
