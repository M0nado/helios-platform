...
actions=[('Run all safe reports','./helios.sh all'),('Refresh local GUI','curl -X POST http://127.0.0.1:8787/rebuild'),('GitHub inventory','./helios.sh github'),('Azure inventory','./helios.sh azure'),('Cross-access profiles','python3 scripts/integrations/cross_access_profiles.py'),('Readiness score','./helios.sh readiness'),('App automation readiness','./helios.sh apps'),('Open local app shell','./helios.sh local-app'),('Doctor','./helios.sh doctor'),('PR body preview','./helios.sh pr-update --dry-run'),('Codex packets','./helios.sh codex'),('Build graph','./helios.sh build'),('Open dashboard','./helios.sh dashboard'),('Finish apply plan','python3 scripts/apply/finish_readiness_apply.py'),('Apply safe finish steps','python3 scripts/apply/finish_readiness_apply.py --apply')]
