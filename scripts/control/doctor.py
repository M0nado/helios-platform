...
lines += ['','## One-command path','','```bash','scripts/setup/helios-dev.sh --serve','```','','## PR update path','','```bash','python3 scripts/github/update-pr-from-reports.py --dry-run','python3 scripts/github/update-pr-from-reports.py --apply','```']
