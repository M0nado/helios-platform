...
report = {
    ...
    "linear": env_status(cfg.get("linear", {}).get("env", [])),
    "githubMcp": env_status(cfg.get("githubMcp", {}).get("env", [])),
    "appAutomation": cfg.get("appAutomation", {}),
    ...
    "automationPaths": path_status([
        ...
        "scripts/integrations/app_automation.py",
