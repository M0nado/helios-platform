...
COMMANDS: list[dict[str, Any]] = [
    ...
    {"id": "fsharp-category-report", "domain": "analytics", "language": "fsharp", "ownerAgent": "fsharp-oracle", "requiredTool": "python3", "command": "python3 scripts/analytics/fsharp_category_report.py", "fixer": "python3 scripts/analytics/fsharp_category_report.py"},
