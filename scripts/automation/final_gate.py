...
COMMANDS: list[dict[str, Any]] = [
    ...
    {"id": "python-language-split", "domain": "architecture", "language": "mixed", "ownerAgent": "csharp-center", "requiredTool": "python3", "command": "python3 scripts/automation/python_language_split_report.py", "fixer": "python3 scripts/automation/python_language_split_report.py"},
