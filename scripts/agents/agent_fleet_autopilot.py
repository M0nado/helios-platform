...
JOB_BLUEPRINTS=[
 ...
 {'job':'python-aihub-integration','primary':'hermes-builder','backup':'xcore-learning-scorer','domain':'python-aihub','ide':'codex-cli','tools':['python3','codex'],'outputs':['provider glue','report JSON/MD','AIHub adapters'],'avoidOverlap':'Python owns provider/report glue only; C# keeps orchestration and UI contracts.'},
