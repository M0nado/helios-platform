...
JOB_BLUEPRINTS=[
 ...
 {'job':'copilot-codex-azure-ide','primary':'hermes-builder','backup':'xcore-model-router','domain':'python-aihub','ide':'github-copilot-ide','tools':['gh','codex','az'],'outputs':['Copilot prompts','Codex task plan','Azure what-if handoff'],'avoidOverlap':'Copilot suggests IDE-level edits/commands, Codex executes repo patches, Azure lane only runs what-if/vault checks.'},
