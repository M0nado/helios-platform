...
function systems(): SystemRecord[] {
  ...
  return [
    ...
    ...[
      ...
      ["slack", "Slack", "Engineering operations and alerts", "HELIOS_SLACK_URL", "https://helios-xk97943.slack.com/archives/C0BHWDBHG1W"],
      ...
      ["linear", "Linear", "Milestones, blockers, and ownership", "HELIOS_LINEAR_URL", "https://linear.app/641974/project/helios-integration-fabric-40e1dd9caa39"],
...
function createServer(): McpServer {
  ...
  registerAppTool(server, "fetch", {
    ...
    inputSchema: { id: z.enum(["github", "azure", "sharepoint", "slack", "teams", "linear", "copilot"]) },
    annotations: { readOnlyHint: true, destructiveHint: false, openWorldHint: false },
    _meta: {},
  }, async ({ id }) => {
