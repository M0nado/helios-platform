...
| Legacy quarantine | Imported/unstable core and tests | Manual only | `HELIOS.Legacy.Quarantine.slnx` isolates non-buildable legacy code from the stable CI lane. |
