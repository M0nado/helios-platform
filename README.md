...
- **[OWNER_START_HERE.md](docs/setup/OWNER_START_HERE.md)** - Click-by-click owner checklist for GitHub organization/enterprise settings, Azure CLI direct setup, branch protection, and repository governance
